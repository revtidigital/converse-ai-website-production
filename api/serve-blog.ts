...
// Slugs served with robots "noindex, follow" and dropped from the sitemap.
// Cleared 2026-07-21: the old 2025 hospitality/banking/generic-chatbot posts are now
// allowed back into the index. Keep the empty set (and the isNoindex logic below) so
// any slug can be re-added later without re-wiring. Inlined (not a shared api/_*.ts
// module) because Vercel excludes underscore-prefixed files from the bundle.
